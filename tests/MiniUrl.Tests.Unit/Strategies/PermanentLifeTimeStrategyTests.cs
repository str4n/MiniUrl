...
public class PermanentLifeTimeStrategyTests : ShorteningStrategyTests
{
    [Fact]
    ...
    public PermanentLifeTimeStrategyTests()
    {
        _shorteningStrategy = new PermanentLifeTimeStrategy(Repository, Clock, CodeGenerator);
    }
}